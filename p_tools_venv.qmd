...
On your desktop or in your `Documents` folder, create a new folder and name it `si_analytics_python`. This is going to be the main folder for many of the projects for this course so make sure you put it in an easy to reach place.   

Open VS Code.

Go to **File > Open Folder**.

Navigate to the `si_analytics_python` folder you just created and select it.
